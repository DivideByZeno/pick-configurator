export default function PickThickness({name, tag, price, summary, handleThickness, currentThickness}) {
    return (
        ...
        <div className="col-md-6 col-xl-3 mb-4">
            <div className="card materialCard shadow border-start-primary py-2" onClick={() => handleThickness(tag)}>
                <div className="card-body">
                    <div className="row align-items-center no-gutters">
                        <div className="col me-2">
                            ...
                            onChange={() => handleThickness(tag)} checked={currentThickness === tag}></input>
