    ...
    return (
        <>
            <div className="col-md-6 col-xl-3 mb-4">
                <div className="card bodyTypeCard shadow border-start-primary py-2" onClick={() => handleBodyType(tag)}>
                    <div className="card-body">
                        <div className="row align-items-center no-gutters">
                            <div className="col me-2">
                                <h6 className="text-uppercase mb-1 fw-bold"><span>{ name }</span></h6>
                                <div className="row g-0 align-items-center">
                                <input className="form-check-input col-auto m-0" type="radio" name="exampleRadios" id={ tag } value={ tag } onChange={() => handleBodyType(tag)} checked={currentBodyType === tag}></input>
